...
ActiveRecord::Schema.define(version: 2022_04_05_214714) do
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.index ["manufacturers_id"], name: "index_items_on_manufacturers_id"
  ...
  add_foreign_key "items", "manufacturers", column: "manufacturers_id"
